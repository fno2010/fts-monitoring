...
class FileBase(models.Model):
    ...
    archive_metadata = models.CharField(max_length = 1024)
    user_filesize     = models.FloatField()
    staging_start     = models.DateTimeField()
    staging_finished  = models.DateTimeField()
    archive_start_time   = models.DateTimeField()
    archive_finish_time  = models.DateTimeField()
...
class Storage(models.Model):
    ...
    skip_eviction           = models.CharField(max_length=1)
